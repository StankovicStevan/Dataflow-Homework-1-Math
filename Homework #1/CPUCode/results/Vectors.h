 ...
 * \param [in] instream_inVector2 The stream should be of size ((param_N * 4) * 4) bytes.
 * \param [out] outstream_outVector The stream should be of size ((param_N * 4) * 4) bytes.
 */
void Vectors(
	int32_t param_N,
	const uint32_t *instream_inVector1,
	const uint32_t *instream_inVector2,
...
typedef struct { 
	...
	const uint32_t *instream_inVector1; /**<  [in] The stream should be of size ((param_N * 4) * 4) bytes. */
	const uint32_t *instream_inVector2; /**<  [in] The stream should be of size ((param_N * 4) * 4) bytes. */
	uint32_t *outstream_outVector; /**<  [out] The stream should be of size ((param_N * 4) * 4) bytes. */
} Vectors_actions_t;
